...
LPC_GPIO0->FIODIR|=((1UL<<A0)|(1UL<<E1));
LPC_GPIO1->FIODIR|=(1UL<<RW);
...
LPC_PINCON->PINSEL1&=~(1<<((E1-16)*2))&~(1<<(((E1-16)*2)+1));
	
LPC_PINCON->PINSEL3&=~(1<<((E2-16)*2))&~(1<<(((E2-16)*2)+1));

LPC_PINCON->PINSEL1&=~(1<<((A0-16)*2))&~(1<<(((A0-16)*2)+1));

LPC_PINCON->PINSEL3&=~(1<<((RW-16)*2))&~(1<<(((RW-16)*2)+1));
...
#if(D0<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D0*2))&~(1<<((D0*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D0-16)*2))&~(1<<(((D0-16)*2)+1));
	}
#endif

#if(D1<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D1*2))&~(1<<((D1*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D1-16)*2))&~(1<<(((D1-16)*2)+1));
	}
#endif
	
#if(D2<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D2*2))&~(1<<((D2*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D2-16)*2))&~(1<<(((D2-16)*2)+1));
	}
#endif
	
#if(D3<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D3*2))&~(1<<((D3*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D3-16)*2))&~(1<<(((D3-16)*2)+1));
	}	
#endif
	
#if(D4<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D4*2))&~(1<<((D4*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D4-16)*2))&~(1<<(((D4-16)*2)+1));
	}
#endif

#if(D5<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D5*2))&~(1<<((D5*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D5-16)*2))&~(1<<(((D5-16)*2)+1));
	}
#endif
	
#if(D6<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D6*2))&~(1<<((D6*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D6-16)*2))&~(1<<(((D6-16)*2)+1));
	}
#endif
	
#if(D7<16)
	{
	LPC_PINCON->PINSEL2&=~(1<<(D7*2))&~(1<<((D7*2)+1));
	}
#else 	
	{
	LPC_PINCON->PINSEL3&=~(1<<((D7-16)*2))&~(1<<(((D7-16)*2)+1));
	}
#endif	
...
LPC_GPIO1->FIODIR|=(1<<D0)|(1<<D1)|(1<<D2)|(1<<D3)|(1<<D4)|(1<<D5)|(1<<D6)|(1<<D7)|(1<<E2)|(1<<RW);
LPC_GPIO0->FIODIR|=(1<<A0)|(1<<E1);
