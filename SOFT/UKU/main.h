...
extern signed short Ubat_e[5];		    	//напряжения ячеек батареи
extern signed short Ubat_e_imbalance[5];	//разбалансы ячеек батареи в процентах (отношение отклонения от среднего к среднему)
extern signed short Ubat_e_imbalance_cnt[5];	//счетчики разбаланса ячеек батареи (антидребезг 10 минут)
extern char 		 Ubat_e_imbalance_stat[5];	//статусы разбаланса ячеек батареи 
